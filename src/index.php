---
current_page: home
background_image: /rows-of-small-candles.jpg
...
<div class="w3-row">
    <div class="w3-col m5 w3-center w3-black w3-padding w3-round-large">
        <p><img src="--- metadata.images-url ---/backgrounds/pouring-oil-on-hand.jpg" alt="Image of Pouring Oil on Hand" class="w3-image w3-round-large"></p>
        <p class="w3-large"><b>Massage</b></p>
        <p><a href="/massage" class="w3-button w3-block w3-deep-purple w3-hover-pink w3-round-large">Find Out More</a></p>
    </div>
    ...
    <div class="w3-col m5 w3-center w3-black w3-padding w3-round-large">
        ...
        <p><a href="https://littleinnocentangel.sites.bypw.me" target="_blank" class="w3-button w3-block w3-deep-purple w3-hover-pink w3-round-large">Find Out More</a></p>
    </div>
</div>
